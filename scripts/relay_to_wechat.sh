...
")
/Applications/AutoClaw.app/Contents/Resources/node/darwin-arm64/node \
  /Applications/AutoClaw.app/Contents/Resources/gateway/openclaw/openclaw.mjs \
  message send   --channel openclaw-weixin   --target "$TARGET"   --message "$OPENCLAW_MSG"   --timeout-ms 15000 > /tmp/relay_gw_resp.txt 2>/dev/null

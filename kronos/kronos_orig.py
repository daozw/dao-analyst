...
def calc_time_stamps(x_timestamp):
    ...
    time_df['minute'] = pd.Series(x_timestamp).dt.minute
    time_df['hour'] = pd.Series(x_timestamp).dt.hour
    time_df['weekday'] = pd.Series(x_timestamp).dt.weekday
    time_df['day'] = pd.Series(x_timestamp).dt.day
    time_df['month'] = pd.Series(x_timestamp).dt.month
    return time_df
